...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # <--- AJOUTE pour render
...
STATIC_ROOT = BASE_DIR / "staticfiles"  # <--- AJOUTE CETTE LIGNE pour render
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage' # <--- AJOUTE CETTE LIGNE pour render   
